 ...
 */
package dbms;
import Projectconn.Connectionprovider;
import java.sql.*;
...
public class Signup extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String U_mobileNo=jTextField4.getText();
        String email_id=jTextField5.getText();
        String password=jTextField6.getText();
        String confirm_password=jTextField7.getText();
        String can_id=jTextField8.getText();
        ...
        try
        {
            ...
            st.executeUpdate("insert into user values('"+User_id+"','"+Fname+"','"+Minit+"','"+Lname+"','"+U_mobileNo+"','"+email_id+"','"+password+"') ");
